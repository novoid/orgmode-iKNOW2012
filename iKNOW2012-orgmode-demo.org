...
can simplify the writing process itself, create additional value by
having an easy to invoke data processing method, and it illustrates
the author's work in the most transparent way possible.
